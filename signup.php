...
<?php
  $title = "Signup • My Story";
  $keywords = "My Story, Share and capture world's moments, share, capture, share, login, signup";
  $desc = "My Story lets you capture, follow, like and share world's moments in a better way and tell your story with photos, messages, posts and everything in between";
?>
  ...
  <div class="input_wrapper">
    ...
    <div class="sign_up_div">
      <form class="sign_up" id="sign_up" action="" method="post">
        ...
        <label for="s_terms" class="terms">I agree to <a href="terms" class="a_pri">My Story Terms</a></label>
