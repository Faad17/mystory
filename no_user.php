...
<?php
  $title = "{$noti->titleNoti()} Member not found • Mystory";
  $keywords = "eror, 404, document not found, webpage not found, Mystory, Share and capture world's moments";
  $desc = "There's been an error • Mystory";
?>
