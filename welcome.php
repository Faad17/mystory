...
<?php
  $title = "Mystory";
  $keywords = "Mystory, Share and capture world's moments, share, capture, share, login, signup";
...
<div class="index_wrapper">
  ...
  <div class="banner">
    <img src="<?php echo DIR; ?>/images/needs/dbx_29.jpg" alt="Mystory">
  ...
  <div class="feature">
    <div class="feature_desc">
      ...
      <h3>Mystory helps you connect with people with your amazing photos, videos and everything in between.</h3>
