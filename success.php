...
<?php
  $title = "Thanks for registering • Mystory";
...
<html>
  <head>
    ...
    <meta name="author" content="Mystory, Subho">
...
<div class="badshah">
  ...
  <div class="about_div inst success_div">
    ...
    <div class="">
      ...
      <span>Mystory is hosted freely, so you'll find it bit slow, because hosting company has allowed limited requests per minute.</span>
